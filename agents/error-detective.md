...
- Use codebase-pattern-finder to trace error origins in code
- Use database-optimizer for database-related errors
- Use technical-debt-manager to assess if errors stem from tech debt
