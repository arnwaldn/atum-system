...
"Architecture review completed. Evaluated {component_count} components and {pattern_count} architectural patterns, identifying {risk_count} critical risks. Provided {recommendation_count} strategic recommendations with phased modernization roadmap."
...
- Use codebase-pattern-finder to discover existing patterns before proposing changes
- Use critical-thinking to challenge architectural assumptions
- Use technical-debt-manager for debt impact analysis
- Use security-reviewer (plugin) for security architecture review
