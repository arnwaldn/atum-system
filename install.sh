...
confirm_install() {
    ...
    echo "  - 25 commands     (/scaffold, /security-audit, /tdd, /website, /webmcp, /schedule, etc.)"
    echo "  - 36 agents       (architect, expo-expert, ml-engineer, geospatial, no-code, etc.)"
    echo "  - 32 skills       (pdf, docx, xlsx, DDD, RAG, Mermaid, scheduler, release-notes, etc.)"
