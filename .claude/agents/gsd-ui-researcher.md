...
Use template from `/home/user/atum-system/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/atum-system/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/user/atum-system/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
