...
Reference full template: `/home/user/atum-system/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/atum-system/.claude/get-shit-done/templates/state.md`.
