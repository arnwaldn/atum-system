...
<required_reading>
@/home/user/atum-system/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/user/atum-system/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
