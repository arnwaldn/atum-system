...
See /home/user/atum-system/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /home/user/atum-system/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /home/user/atum-system/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /home/user/atum-system/.claude/get-shit-done/templates/discovery.md
...
Use /home/user/atum-system/.claude/get-shit-done/templates/discovery.md.
