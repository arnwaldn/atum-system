...
<execution_context>
@/home/user/atum-system/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/atum-system/.claude/get-shit-done/workflows/manager.md end-to-end.
